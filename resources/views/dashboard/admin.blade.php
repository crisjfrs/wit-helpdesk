...
@section('page-title', 'Tytyd Admin')

@section('content')
<div class="dashboard-shell">
    <div class="dashboard-hero">
        <h2>Control Center Admin</h2>
        <p>
            Pantau kesehatan operasional helpdesk, evaluasi beban tiket, dan ambil tindakan cepat untuk menjaga SLA tetap aman.
        </p>
        <div class="hero-actions">
            <a href="{{ route('tickets.index') }}" class="btn btn-sm btn-outline">Lihat Semua Tiket</a>
            <a href="{{ route('reports.index') }}" class="btn btn-sm btn-secondary">Buka Laporan</a>
        </div>
    </div>
